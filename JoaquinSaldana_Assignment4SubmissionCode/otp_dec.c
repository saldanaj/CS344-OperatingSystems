/*
 ...
 Description: This is the decryption program that sends the plantext and key to the encryption server
...
int main(int argc, char *argv[])
{
    ...
    // Get the name of the encrypted file from the command line
    encryptedTextFile = argv[1];
    ...
    int plainTextSize = findFileSize(encryptedTextFile);
    ...
    // Send number to server to indicate an decryption is needed
    sprintf(buffer,"1\n");
    ...
    // Now doing the same for the encrypted file
